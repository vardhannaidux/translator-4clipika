...
CONSONANTS = {
    ...
    U_TTA: {'head': 229, 'tail': None, 'vattu': [100], 'head_i': 230, 'matra_i_post': 168, 'head_ii': 230, 'matra_ii_post': 169, 'head_ee': None, 'uu_alt': False, 'head_aa': 230, 'aa_post': 176, 'head_halant': 230, 'tail_halant': 192},
    ...
    U_TA: {'head': 234, 'tail': 159, 'vattu': [104], 'head_i': 65, 'head_ii': 66, 'head_ee': 234, 'uu_alt': False, 'u_keep_tail': True, 'head_oo': 234, 'oo_post': 193, 'oo_no_tail': True, 'head_e': 234, 'e_post': 181, 'ee_post': 182, 'aa_post': 165, 'tail_halant': 194, 'matra_override': {'ై': [234, 181, 106]}},
    ...
    U_BA: {'head': 241, 'tail': None, 'vattu': [40], 'head_ii': None, 'head_ee': None, 'uu_alt': True, 'head_aa': 242, 'aa_post': 176, 'head_halant': [242, 203], 'tail_halant': 192},
    ...
    U_YA: {'head': 243, 'tail': 159, 'tail2': 170, 'vattu': [117], 'head_ii': 244, 'head_ee': None, 'uu_alt': False, 'u_keep_tail': True, 'u_no_tail2': True, 'matra_i_post': 179, 'matra_u_post': 179, 'head_aa': 243, 'aa_post': 171, 'aa_keep_tail': True, 'aa_no_tail2': True, 'head_i': 244},
...
CONJUNCT_RULES: dict[tuple[str, str | None, str | tuple[str, ...] | None], list[int]] = {
    ...
    (U_KA, None, U_SSA): [164],
    (U_KA, None, (U_SSA,)): [164],
    (U_KA, M_AA, U_SSA): [164, 165],
    (U_KA, M_AA, (U_SSA,)): [164, 165],
    (U_KA, M_U, U_SSA): [164, 170],
    (U_KA, M_U, (U_SSA,)): [164, 170],
    ...
    (U_GHA, M_AA, None): [237, 198, 163, 171],
    ...
    (U_SA, M_UU, (U_KA,)): [250, 163, 171, 92],
    (U_RA, M_I, (U_JA,)): [74, 98],
    (U_RA, M_I, U_JA): [74, 98],
    (U_PA, M_AA, (U_PA,)): [240, 167, 112],
    (U_LA, M_I, (U_CA,)): [76, 97],
    (U_BA, M_I, (U_JA,)): [71, 98],
    (U_BA, M_I, U_JA): [71, 98],
    (U_RA, None, (U_SA,)): [244, 194, 113],
...
PHRASE_MAPPINGS = {
    ...
    'రమేష్ రాజు': 'ô¢î¶ªùÃ ô¦V',
    'రమేష్': 'ô¢î¶ªùÃ',
    'ఫ్లాష్': 'ð§xùÃ',
    'ఉపాధ్యాయులు': 'Ñð§ëÅ¯uóŸ³õª',
    'ఫిట్ నెస్': 'íÆ‡æÀ ûµúÃ',
    ...
    'శ్రామిక శక్తి': bytes([118, 248, 139, 78, 170, 218, 219, 32, 248, 140, 218, 168, 104]).decode('cp1252'),
    ...
    'ఫ్లాష్ న్యూస్': bytes([240, 167, 120, 249, 195, 32, 236, 171, 117, 250, 195]).decode('cp1252'),
    ...
    'హార్డ్ వేర్': bytes([239, 163, 132, 244, 194, 147, 32, 238, 182, 244, 194]).decode('cp1252'),
    ...
    'స్వచ్ఛమైన': bytes([250, 136, 121, 224, 159, 97, 196, 238, 181, 170, 105, 236]).decode('cp1252'),
    ...
    'ఆన్ లైన్': bytes([206, 251, 194, 32, 246, 203, 181, 106, 251, 194]).decode('cp1252'),
    'ఆధార్ తో': bytes([206, 235, 197, 175, 244, 194, 32, 234, 193]).decode('cp1252'),
    ...
    'స్వామి': bytes([250, 136, 121, 78, 170]).decode('cp1252'),
    ...
    'రెడ్డి': bytes([183, 244, 232, 133, 34]).decode('cp1252'),
    ...
    'స్వా': bytes([250, 136, 121, 165]).decode('cp1252'),
    ...
    'క్కు': bytes([218, 219, 170, 92]).decode('cp1252'),
    ...
    'స్వ': bytes([250, 136, 121]).decode('cp1252'),
    ...
    'న్ లో': bytes([251, 194, 32, 246, 203, 186]).decode('cp1252'),
    'శుభాకాంక్షలు': bytes([248, 140, 137, 242, 197, 176, 218, 165, 217, 164, 219, 245, 170]).decode('cp1252'),
    'ఉద్దేశం': bytes([105, 209, 235, 182, 204, 196, 248, 140, 217]).decode('cp1252'),
}
...
EDITORIAL_CORRECTIONS = {
    'öËqÀ': 'öËÀq',
    'Í÷±æÀ': 'Í÷±æÀ', # User listed Í÷±æÀ -> ÚÛæ®æÀ in raw text prompt alignment, let's include exact matching for Í÷±æÀ
    'všíÆÙèqÂ': 'všíÆÙèÂq',
    '›ú¥dôÂq': 'þ¼dôÂq',
    'ÎôÂëÇÁšíè…ÚÂ': 'ÎôÁ–šíè…ÚÂ',
    'ÚÛ”ú°gô¦÷±': 'ÚÛ”ÿ§gô¦÷±',
    'Ú¥ô¢uõóŸªÙ': 'Ú¥ô¦uõóŸªÙ',
    'ô¢î¶ªù£ ô¦V': 'ô¢î¶ªùÃô¦V',
    'ô¢î¶ªùÃ ô¦V': 'ô¢î¶ªùÃô¦V',
    'ðÆ§xùÃ': 'ð§xùÃ',
    'Ñð§ë¯uóŸ³õª': 'Ñð§ëÅ¯uóŸ³õª',
    'íÆ‡æÀ ûµúÃ': 'íÆ‡æÀûµúÃ',
